      ...
      <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between text-sm">
            <span className="text-orange-600 font-medium">${postData?.priceRangeStart}- ${postData?.priceRangeEnd}</span>
            <span className="text-gray-500">{postData?._count?.comments}reviews</span>
          </div>
        </div>
      </div>
    </Link>
